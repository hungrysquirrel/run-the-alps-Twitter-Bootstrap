...
################################################################################
  function bootstrapwp_css_loader() {
    ...
    wp_enqueue_style('screen', get_template_directory_uri().'/css/screen.css', false ,'6.6', 'all' );
...
################################################################################
  function bootstrapwp_js_loader() {
       ...
       wp_enqueue_script('site_js', get_template_directory_uri().'/js/site_js.js', array('jquery'),'2.5', true );
  }
...
/*
| -------------------------------------------------------------------
| Adding Bootstap 4 responsive image class to all images in blog
| -------------------------------------------------------------------
| */
function add_responsive_class($content){
        ...
        foreach ($imgs as $img) {           
           $img->setAttribute('class','img-fluid m-x-auto');
        }
...
function bootstrapwp_excerpt($more) {
       global $post;
  return '&nbsp; &nbsp;<a class="continue-reading-link" href="'. get_permalink($post->ID) . '" ">Continue Reading &rarr;</a>';
}
...
<ul class="pager">
		<?php previous_post_link( '<li class="previous">%link</li>', '<span class="meta-nav">' . _x( '&larr;', 'Previous post link', 'bootstrapwp' ) . '</span> Previous Post' ); ?>
		<?php next_post_link( '<li class="next">%link</li>', 'Next Post <span class="meta-nav">' . _x( '&rarr;', 'Next post link', 'bootstrapwp' ) . '</span>' ); ?>
</ul>
...
add_filter        ('get_the_content', 'remove_caption');
*/
...
==================================================================================== **/
function rta_rss_template() {
	add_feed( 'mailchimp', 'rta_custom_rss_render' );
}

add_action( 'after_setup_theme', 'rta_rss_template' );

function rta_custom_rss_render() {
